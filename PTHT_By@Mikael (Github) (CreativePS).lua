-------------------------------------------------------------------------
Loop = 3 -- Mau Berapa x PTHT Auto Stop
plantid = 5640 -- ID Magplant
harvestid = 14459 -- ID Pohon
----------------------------------------------------------------------
Nanem = 100 -- Delay Nanem
Panen = 130  -- Delay Panen
-------------------------------------------------------------------------
ey, ex = 191, 199 -- Kordinat Plant
eyy, exx = 191, 7 -- Kordinat Harvest
-------------------------------------------------------------------------
...
|text| `b. [ `2Script `8PTHT  `bBy `#@Caitriona `b] . ]])
    Sleep(1000)
end
...
plant()
    Looping = Looping + 1
    SendPacket(2, "action|input\ntext|`2Success PTHT: `b( `9"..Looping.." `b)  Script `bBy: `8@Caitriona (gems) ")
end
